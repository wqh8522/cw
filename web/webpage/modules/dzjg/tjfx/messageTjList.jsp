...
<div class="wrapper wrapper-content">
    <div class="ibox">
        ...
        <div class="ibox-content">
            ...
            <div class="row">
                <div class="col-sm-12">
                    <form:form id="searchForm" modelAttribute="messageTj" action="${ctx}/dzjg/tjfx/messagetj"
                        ...
                        <div class="form-group" style="">
                            ...
                            <input name="queryDate" id="queryDate" style="width: 150px;"
                                   value="${messageTj.queryDate}" size="10px"
                                   class="laydate-icon form-control layer-date"/>
                            <span>：</span>
                            <span>单位：</span>
                            <sys:treeselect id="office" name="officeId" value="${messageTj.officeId}"
                                            labelName="officeName"  cssStyle="width: 150px" labelValue="${messageTj.officeName}"
                                            title="部门" url="/sys/office/treeData?type=2"
                                            cssClass="form-control required" notAllowSelectParent="false"/>
                            <span>单位类型：</span>
                ...
                <div class="col-sm-12">
                    <div class="pull-left">
                        <shiro:hasPermission name="dzjg:jrlq:tj">
                            <table:exportExcel url="${ctx}/dzjg/tjfx/export/messageTj"></table:exportExcel><!-- 导出按钮 -->
                        </shiro:hasPermission>
            ...
            <table id="contentTable"
                ...
                <thead>
                <tr>
                    <td colspan="${messageTj.weeks.size()*2+3}" align="center"><h3>${messageTj.year}年${messageTj.month}月各单位信息报送情况</h3>
                    </td>
                </tr>
                <tr a>
                    <th width="10px" align="center"></th>
                    <th class="sort-column o.name">单位</th>
                    <c:forEach items="${messageTj.weeks}" var="week" varStatus="vs">
