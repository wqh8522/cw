...
public class MailController extends BaseController {
	...
	public String save(Mail mail, Model model, HttpServletRequest request, RedirectAttributes redirectAttributes) {
		if (!beanValidator(model, mail)){
			return form(mail, model);
		}
		mailService.save(mail);
		String loginfo = "删除站内信["+ mail.getTitle() +"]";
	...
	public String delete(Mail mail, HttpServletRequest request, RedirectAttributes redirectAttributes) {
