...
public interface UserDao extends CrudDao<User> {
	...
	public List<User> findUserByOrgAndRole(@Param("officeid")String officeid, @Param("roleid")String roleid);
	 ...
	 * @return
	 */
	public List<User> findReadedList(User user);
	 ...
	 * @return
	 */
	public List<User> findUnreadList(User user);
}
