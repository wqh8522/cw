...
public class MailComposeService extends CrudService<MailComposeDao, MailCompose> {
	...
	public List<String> getDetail(MailCompose mailCompose) {
		return mailComposeDao.getDetail(mailCompose);
	}
	
	public List<String> getDetailId(MailCompose mailCompose) {
		return mailComposeDao.getDetailId(mailCompose);
	}
