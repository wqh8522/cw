...
<div class="ibox-title">
	...
	<div class="row">
	<div class="col-sm-12">
	<form:form id="searchForm" action="${ctx}/sys/log4/" method="post"  class="form-inline">
	...
	<div class="col-sm-12">
		<div class="pull-left">
			<shiro:hasPermission name="sys:log4:del">
				<table:delRow url="${ctx}/sys/log4/deleteAll" id="contentTable"></table:delRow><!-- 删除按钮 -->
				<button class="btn btn-white btn-sm "  onclick="confirmx('确认要清空日志吗？','${ctx}/sys/log4/empty')"  title="清空"><i class="fa fa-trash"></i> 清空</button>
			</shiro:hasPermission>
