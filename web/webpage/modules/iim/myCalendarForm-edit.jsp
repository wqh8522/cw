...
<div class="fancy">
    ...
    <span id="sel_start"   <c:if test="${start_h == '.' || start_h == ''}">style="display: none;"</c:if>>
    <select name="s_hour">
    ...
    <p id="p_endtime" <c:if test="${end_d == '' || end_d == null}">style="display: none;"</c:if>>结束时间：<input type="text" class="input datepicker" name="enddate" id="enddate" value="${end_d}" readonly>
