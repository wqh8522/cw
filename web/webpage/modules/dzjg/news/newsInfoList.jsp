...
<body class="gray-bg">
	...
	<div class="row">
	<div class="col-sm-12">
	<form:form id="searchForm" modelAttribute="TDzjgNews" action="${ctx}/dzjg/news/info" method="post" class="form-inline">
	...
	<div class="col-sm-12">
		<div class="pull-left">
			<shiro:hasPermission name="dzjg:news:add">
				<table:addRow url="${ctx}/dzjg/news/form" title="新闻报道"  height="600px" label="新增新闻报道"></table:addRow><!-- 增加按钮 -->
			</shiro:hasPermission>
			...
			<shiro:hasPermission name="dzjg:news:del">
				<table:delRowInfo url="${ctx}/dzjg/news/deleteAll" id="contentTable"></table:delRowInfo><!-- 删除按钮 -->
			</shiro:hasPermission>
	...
	<table id="contentTable" class="table table-striped table-bordered table-hover table-condensed dataTables-example dataTable">
		...
		<c:forEach items="${page.list}" var="news" varStatus="vs">
			<tr>
				...
				<td width="500px"><a  href="#" onclick="openDialogView('查看新闻管理', '${ctx}/dzjg/news/form?id=${news.id}','800px', '600px')">
						${news.title}
				</a></td>
				<td width="60px">
						${news.createBy.name}
				...
				<td width="180px">
					...
					<shiro:hasPermission name="dzjg:news:edit">
    					<a href="#" onclick="openDialog('修改新闻管理', '${ctx}/dzjg/news/form?id=${news.id}&type=info','800px', '600px')" class="btn btn-success btn-xs" ><i class="fa fa-edit"></i> 修改</a>
    				</shiro:hasPermission>
    				<shiro:hasPermission name="dzjg:news:del">
						<a href="${ctx}/dzjg/news/delete?id=${news.id}&type=info" onclick="return confirmx('确认要删除该新闻管理吗？', this.href)"   class="btn btn-danger btn-xs"><i class="fa fa-trash"></i> 删除</a>
					</shiro:hasPermission>
				</td>
			</tr>
		</c:forEach>
