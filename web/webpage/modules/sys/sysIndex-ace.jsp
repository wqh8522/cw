								...
								<li class="dropdown-content">
									<ul class="dropdown-menu dropdown-navbar">
										 <c:forEach items="${mailPage.list}" var="mailBox">
											 <li>
												 <a href="${ctx}/iim/mailBox/detail?id=${mailBox.id}" class="clearfix J_menuItem">
													 <img src="${ctxRoot }/asset/images/head_default.png" class="msg-photo" alt="Fred's Avatar" />
												<span class="msg-body">
													<span class="msg-title">
														<span class="blue">${mailBox.sender.name }:</span>
														${fns:abbr(mailBox.mail.title,40)}
													</span>

													<span class="msg-time">
														<i class="ace-icon fa fa-clock-o"></i>
														<span><fmt:formatDate value="${mailBox.sendtime}" pattern="yyyy-MM-dd HH:mm"/></span>
													</span>
												</span>
												 </a>
											 </li>
