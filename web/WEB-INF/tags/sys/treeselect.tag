...
<%@ attribute name="simpleCheck" type="java.lang.Boolean" required="false" description="是否不影响父子节点"%>
...
<script type="text/javascript">
	$("#${id}Button, #${id}Name").click(function(){
		...
		top.layer.open({
		    ...
		    content: "${ctx}/tag/treeselect?url="+encodeURIComponent("${url}")+"&module=${module}&checked=${checked}&extId=${extId}&isAll=${isAll}&simpleCheck=${simpleCheck}" ,
		    btn: ['确定', '关闭']
