...
<div class="ibox-title">
	...
	<table id="treeTable" class="table table-striped table-bordered  table-hover table-condensed  dataTables-example dataTable">
		...
		<c:forEach items="${page.list}" var="dict" varStatus="status">
			<tr <%-- id="${dict.id}" pId="${dict.parentId} --%>">
				<td> 
				...
				<c:if test="${flag=='1'}">
					...
					<shiro:hasPermission name="sys:dict:add">
					    <a href="#" onclick="openDialog('添加键值1', '${ctx}/sys/dict/form?type=${dict.type}&sort=${dict.sort+10}&description=${dict.description}','800px', '500px')" class="btn btn-success btn-xs" ><i class="fa fa-edit"></i> 添加键值</a>
