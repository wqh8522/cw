                        	...
                        	<c:forEach items="${page.list}" var="mailCompose" varStatus="vs">
								<tr>
                                	...
                                	<td class="mail-ontact"><a href="${ctx}/iim/mailCompose/draftDetail?id=${mailCompose.id}">
										<c:if test="${fn:length(mailCompose.mail.title)>18 }">  
                      				   ${fn:substring(mailCompose.mail.title, 0, 18)}...  
                   					</c:if>  
                  					<c:if test="${fn:length(mailCompose.mail.title)<=18 }">  
									...
									<td>
                                        ...
                                        <a href="${ctx}/iim/mailCompose/draftDetail?id=${mailCompose.id}" class="btn btn-info btn-xs" ><i class="fa fa-search-plus"></i> 查看</a>
