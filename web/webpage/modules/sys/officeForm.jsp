		   ...
		   <tbody>
		      <tr>
		       ...
		       <tr>
		         ...
		         <td  class="width-15 hidden"  class="active"><label class="pull-right">机构级别:</label></td>
		         <td class="width-35 hidden"><form:select path="grade" class="form-control">
		      ...
		      <tr>
		         ...
		         <td class="width-15 hidden"  class="active"><label class="pull-right">主负责人:</label></td>
		         <td class="width-35 hidden"><sys:treeselect id="primaryPerson" name="primaryPerson.id" value="${office.primaryPerson.id}" labelName="office.primaryPerson.name" labelValue="${office.primaryPerson.name}"
		      ...
		      <tr>
		         <td class="width-15 active hidden"><label class="pull-right">副负责人:</label></td>
		         <td class="width-35 hidden"><sys:treeselect id="deputyPerson" name="deputyPerson.id" value="${office.deputyPerson.id}" labelName="office.deputyPerson.name" labelValue="${office.deputyPerson.name}"
					title="用户" url="/sys/office/treeData?type=3" cssClass="form-control" allowClear="true" notAllowSelectParent="true"/></td>
		         </tr>
		      <tr>
		         <td class="width-15 active hidden"><label class="pull-right">邮政编码:</label></td>
		         <td class="width-35 hidden"><form:input path="zipCode" htmlEscape="false" maxlength="50" cssClass="form-control" /></td>
		         <td  class="width-15 hidden" class="active"><label class="pull-right">负责人:</label></td>
		         <td class="width-35 hidden"><form:input path="master" htmlEscape="false" maxlength="50" cssClass="form-control" /></td>
		      </tr>
		      <tr>
